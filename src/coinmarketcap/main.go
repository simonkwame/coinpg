...
func scrapcmc() (string, error) {
	...
	c.OnHTML("#currencies-all tbody tr", func(e *colly.HTMLElement) {
		...
		coin := Coin{
			...
			CirculatingSupply: e.ChildAttr(".circulating-supply", "data-sort"),
			Marketcap:         finmarketcap,
			Change1hr:         e.ChildAttr("td:nth-child(8)", "data-percentusd"),
			Change24hr:        e.ChildAttr("td:nth-child(9)", "data-percentusd"),
			Change7d:          e.ChildAttr("td:nth-child(10)", "data-percentusd"),
		}
